...
public class SchemaGenCreatePageAction : IEplAction
{
    ...
    public bool Execute(ActionCallingContext ctx)
    {
        ...
        // Format strony (A4 landscape) — z szablonu projektu Hello_world.
        // API 2025 nie udostępnia Properties.Page.DRAWING_DISPLAYEDWIDTH/HEIGHT (CS0117).
        // Granice ramki do layoutu: SchemaGenPaths.Frame* (kalibracja przez SchemaGenAuditLayout).
