...
Do zrobienia po stronie Filip: `build_addin.ps1`, skopiuj MVP + `config/numbering-rules.xml` → `Skrypty\Schemagen\config\`, przeładuj DLL, świeży Hello_world, uruchom MVP, sprawdź MA1+MA2 i `output/renumber-devices.json`
