...
def test_diagonal_join_rejected() -> None:
    """Skos + poziom stykajace sie w punkcie NIE tworza jednego netu."""
    diag = _wire([[40, 60], [120, 140]])  # ~45°
    horiz = _wire([[120, 140], [200, 140]])
    conns, _ = build_connections([diag, horiz], [A, B], join_tol=10, terminal_tol=10)
    assert conns == []
